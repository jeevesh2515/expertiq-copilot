...
export default function RegisterPage() {
  ...
  const [mode, setMode] = useState<AuthPanelMode>("register");
    ...
    <main className="min-h-screen bg-zinc-950 px-4 py-6 text-zinc-100 sm:px-6 lg:px-8">
      <div className="mx-auto flex min-h-[calc(100vh-48px)] w-full max-w-6xl flex-col">
        <header className="flex items-center justify-between">
          ...
          <Link
            href="/"
            className="flex items-center gap-2 rounded-full border border-zinc-800 px-4 py-2 text-sm font-semibold text-zinc-400 transition hover:border-zinc-700 hover:text-zinc-100"
          >
